...
public class Allergyasthima {
    ...
    /** Base URL for Allergy Asthma Technology — https://www.allergyasthmatech.com/ */
    static final String BASE_URL = "https://www.allergyasthmatech.com/";
    ...
    @Test(description = "Open storefront and capture homepage")
    public void test01_openHomepage() throws IOException {
        driver.get(BASE_URL);
        waitForPageFullyLoaded(driver);
        takeFullPageScreenshot(driver, "homepage");
    }

    @Test(dependsOnMethods = "test01_openHomepage", description = "Navigate Allergy Bedding → Dust Mite Covers category")
    public void test02_navigateToDustMiteCategory() throws IOException {
    ...
    @Test(dependsOnMethods = "test02_navigateToDustMiteCategory", description = "Open first PLP product and select configurable options")
    public void test03_openFirstProductAndOptions() throws IOException, InterruptedException {
        WebDriverWait wait = defaultWait();
    ...
    @Test(dependsOnMethods = "test03_openFirstProductAndOptions", description = "Add configured product to cart from PDP")
    public void test04_addToCartFromPdp() throws IOException, InterruptedException {
        WebDriverWait wait = defaultWait();
    ...
    @Test(dependsOnMethods = "test04_addToCartFromPdp", description = "Full cart: open, set quantity, update")
    public void test05_cartUpdateQuantity() throws IOException {
        WebDriverWait wait = defaultWait();
    ...
    @Test(dependsOnMethods = "test05_cartUpdateQuantity", description = "Apply discount coupon on cart")
    public void test06_applyCartCoupon() throws IOException {
        WebDriverWait wait = defaultWait();
    ...
    @Test(dependsOnMethods = "test06_applyCartCoupon", description = "Proceed to checkout, guest email, shipping address")
    public void test07_checkoutGuestAndShipping() throws IOException {
        WebDriverWait wait = defaultWait();
    ...
    @Test(dependsOnMethods = "test07_checkoutGuestAndShipping", description = "Continue to payment step and capture full page")
    public void test08_continueToPaymentStep() throws IOException, InterruptedException {
        WebDriverWait wait = defaultWait();
    ...
    @Test(dependsOnMethods = "test08_continueToPaymentStep", description = "Return home and exercise search with suggestions")
    public void test09_homeSearch() throws IOException, InterruptedException {
        WebDriverWait wait = defaultWait();
        driver.get(BASE_URL);
        waitForPageFullyLoaded(driver);
